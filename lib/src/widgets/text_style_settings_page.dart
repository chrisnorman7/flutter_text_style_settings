...
class TextStyleSettingsPage extends StatefulWidget {
  /// Create an instance.
  const TextStyleSettingsPage({
  ...
  @override
  TextStyleSettingsPageState createState() => TextStyleSettingsPageState();
}

/// State for [TextStyleSettingsPage].
class TextStyleSettingsPageState extends State<TextStyleSettingsPage> {
